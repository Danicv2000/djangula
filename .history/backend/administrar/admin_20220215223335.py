...
from .models import Semestre,Semestre_Cursado,Tipo_Curso,Plan_Estudio,EstudiantePerfil,Curso,ProfesorAsignatura,Grupo,Asignatura_Plan,Asignatura,Anno_Cursado,Disciplina,Profe_Responsabilidades,ProfesorPerfil, Anno, Responsabilidades, Categoria_Docente, Categoria_Cientifica, Titulo, Carrera, Users,,ProfesorAsignaturaAdmin
