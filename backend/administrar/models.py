...
class Relacion (models.Model):
    semestres = models.ForeignKey(Semestre_Cursado, on_delete=models.CASCADE)
    semestre = models.ForeignKey(Semestre, on_delete=models.CASCADE)
...
class Relacionc(models.Model):
    ...
    profesor = models.ForeignKey(ProfesorPerfil, on_delete=models.CASCADE)


class Relaciond(models.Model):
    profesor= models.ForeignKey(Users, on_delete=models.CASCADE)
    responsabilidad = models.ForeignKey(Responsabilidades, on_delete=models.CASCADE)
    responsabildades = models.ForeignKey(Profe_Responsabilidades, on_delete=models.CASCADE)
   

class Relacione(models.Model):
    disciplina= models.ForeignKey(Disciplina, on_delete=models.CASCADE)
    responsabilidad = models.ForeignKey(Profe_Responsabilidades, on_delete=models.CASCADE)


class Relacionf(models.Model):
    carrera= models.ForeignKey(Carrera, on_delete=models.CASCADE)
    profe_responsabilidades = models.ForeignKey(Profe_Responsabilidades, on_delete=models.CASCADE)
  
class Relaciong(models.Model):
    carrera= models.ForeignKey(Carrera, on_delete=models.CASCADE)
    profe_responsabilidades = models.ForeignKey(Profe_Responsabilidades, on_delete=models.CASCADE)
    anno= models.ForeignKey(Anno, on_delete=models.CASCADE)
...
class Relacioni(models.Model):
    anno= models.ForeignKey(Anno_Cursado, on_delete=models.CASCADE)
    profe_responsabilidades = models.ForeignKey(Profe_Responsabilidades, on_delete=models.CASCADE)
    grupo= models.ForeignKey(Grupo, on_delete=models.CASCADE)

class Relacionj(models.Model):
    profesor= models.ForeignKey(ProfesorPerfil, on_delete=models.CASCADE)
    asignatura= models.ForeignKey(Asignatura_Plan, on_delete=models.CASCADE)
    curso= models.ForeignKey(Semestre_Cursado, on_delete=models.CASCADE)
    user= models.ForeignKey(Users, on_delete=models.CASCADE)
    profesor= models.ForeignKey(ProfesorAsignatura, on_delete=models.CASCADE)

class Relacionk(models.Model):
